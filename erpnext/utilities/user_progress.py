	...
	return [
			...
			help_links=[
				{
					...
					"url": ["https://erpv.advintic.com/docs/user/manual/en/accounts/chart-of-accounts"]
				},
				{
		...
		frappe._dict(
			...
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://erpv.advintic.com/docs/user/manual/en/setting-up/setting-company-sales-goal"]
				}
			]
		),
		frappe._dict(
			...
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://erpv.advintic.com/docs/user/manual/en/CRM/customer.html"]
				}
			]
		),
		...
		frappe._dict(
			...
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://erpv.advintic.com/docs/user/manual/en/buying/supplier"]
				},
				{
		...
		frappe._dict(
			...
			help_links=[
				{
					"label": _('Learn More'),
					"url": ["https://erpv.advintic.com/docs/user/manual/en/setting-up/users-and-permissions"]
				},
				{
