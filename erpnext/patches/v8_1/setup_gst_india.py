...
<p>Please refer {gst_document_link} to know more about how to setup and implement GST in ERPV.</p>

<p>Please contact us at support@erpv.advintic.com, if you have any questions.</p>

<p>Thanks,</p>
ERPV Team.
	""".format(gst_document_link="<a href='http://frappe.github.io/erpnext/user/manual/en/regional/india/'> ERPV GST Document </a>")

	try:
		sendmail_to_system_managers("[Important] ERPV GST updates", message)
