...
class TestPaymentRequest(unittest.TestCase):
	...
	def test_payment_request_linkings(self):
		...
		pr = make_payment_request(dt="Sales Order", dn=so_inr.name, recipient_id="saurabh@erpv.advintic.com")
		...
		pr = make_payment_request(dt="Sales Invoice", dn=si_usd.name, recipient_id="saurabh@erpv.advintic.com")
	...
	def test_multiple_payment_entries_against_sales_order(self):
		...
		pr1 = make_payment_request(dt="Sales Order", dn=so.name,
			recipient_id="nabin@erpv.advintic.com", return_doc=1)
		pr1.grand_total = 200
		pr1.submit()
